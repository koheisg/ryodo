class UsersController < ApplicationController
  ...
  def new
    url = "https://github.com/login/oauth/authorize?client_id=#{ENV['GITHUB_CLIENT_ID']}&redirect_uri=#{ENV['APP_HOST']}/github/authorize/callback/signup&scope=user%20repo"
    redirect_to url
  end
